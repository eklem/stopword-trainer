...
fs.createReadStream(reuters000)
  ...
  .on ('end', function () {
    ...
    test('100 stopwords calculated on all content from 000.str (1000 documents)', (assert) => {
      const expected = ['1', '3', '5', '4', '6', '1987', '0', 'the', 'of', 'reuter', '2', 'to', 'said', 'and', 'in', 'a', 'mar', 'for', 'it', 'mln', 'dlrs', 'on', 'usa', 'from', 'is', 'its', 'pct', 'will', 'with', 'at', 'be', 'by', 'year', 'was', 'that', '000', 's', 'vs', 'has', 'u', 'an', 'as', 'new', 'billion', 'inc', 'cts', 'not', 'company', 'which', 'would', 'corp', 'he', 'one', 'but', 'this', 'net', 'are', '15', 'last', 'have', '16', '1986', 'feb', 'were', '10', 'two', 'market', 'bank', '8', '226', 'march', '7', 'or', 'had', 'about', '12', '13', 'up', 'they', 'also', 'earn', 'share', 'stock', 'been', 'government', 'loss', 'shr', 'after', '31', '17', '9', '20', '11', 'co', 'shares', '25', '30', 'over', 'oil', 'more' ]
